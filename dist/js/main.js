...
(function () {
  ...
  if (cartButton && cartPanel) {
    cartButton.addEventListener('click', e => {
      ...
      if (cartPanel.classList.contains('cart-panel--open')) {
        ...
        cartButton.setAttribute('aria-label', 'Закрыть корзину');
        disableScroll();
        ...
        cartButton.setAttribute('aria-label', 'Открыть корзину');
        enableScroll();
      }
    });
  }
  ...
  // Закрытие панелей при клике на Escape
  ...
  // Закрытие панелей при изменении размера окна
